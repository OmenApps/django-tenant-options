...
class TestMetaclassGuards:
    ...
    def test_no_duplicate_fields_in_models(self):
        ...
        assert len(option_field_names) == len(option_unique_fields), (
        ...
        assert len(selection_field_names) == len(selection_unique_fields), (
    ...
    def test_all_option_models_have_required_fields(self):
        ...
        for model_class in all_option_subclasses():
            ...
            for required_field in required_fields:
                ...
                assert model_field_names.count(required_field) == 1, (
